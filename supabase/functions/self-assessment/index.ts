...
const defaultCriteria=[
  {key:"strategic_thinking",title:"Strategic Thinking",description:"มองภาพรวม เชื่อมโยงข้อมูล และวางแนวทางระยะยาว",scale_labels:{"1":"แทบไม่ได้ทำ","2":"ทำบ้าง นานๆ ครั้ง","3":"ทำเป็นประจำ","4":"ทำสม่ำเสมอ จนเกิดผลที่ดี","5":"ทำสม่ำเสมอ เกิดผลที่ดีและพัฒนาต่อเนื่อง"}},
  {key:"coaching",title:"Coaching",description:"สนับสนุนและพัฒนาผู้อื่นด้วยการตั้งคำถามและให้คำแนะนำ",scale_labels:{"1":"แทบไม่ได้ทำ","2":"ทำบ้าง นานๆ ครั้ง","3":"ทำเป็นประจำ","4":"ทำสม่ำเสมอ จนเกิดผลที่ดี","5":"ทำสม่ำเสมอ เกิดผลที่ดีและพัฒนาต่อเนื่อง"}},
  {key:"growth_mindset",title:"Growth Mindset",description:"เปิดรับการเรียนรู้ ทดลอง และพัฒนาตนเองอย่างต่อเนื่อง",scale_labels:{"1":"แทบไม่ได้ทำ","2":"ทำบ้าง นานๆ ครั้ง","3":"ทำเป็นประจำ","4":"ทำสม่ำเสมอ จนเกิดผลที่ดี","5":"ทำสม่ำเสมอ เกิดผลที่ดีและพัฒนาต่อเนื่อง"}},
  {key:"team_execution",title:"Team Execution",description:"ทำงานร่วมกัน เปลี่ยนแผนเป็นผลลัพธ์ และรับผิดชอบต่อเป้าหมาย",scale_labels:{"1":"แทบไม่ได้ทำ","2":"ทำบ้าง นานๆ ครั้ง","3":"ทำเป็นประจำ","4":"ทำสม่ำเสมอ จนเกิดผลที่ดี","5":"ทำสม่ำเสมอ เกิดผลที่ดีและพัฒนาต่อเนื่อง"}},
  {key:"agility",title:"Agility",description:"ปรับตัวและตัดสินใจได้เหมาะสมเมื่อบริบทเปลี่ยนแปลง",scale_labels:{"1":"แทบไม่ได้ทำ","2":"ทำบ้าง นานๆ ครั้ง","3":"ทำเป็นประจำ","4":"ทำสม่ำเสมอ จนเกิดผลที่ดี","5":"ทำสม่ำเสมอ เกิดผลที่ดีและพัฒนาต่อเนื่อง"}}
];
